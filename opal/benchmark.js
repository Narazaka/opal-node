...
Opal.modules["benchmark"] = function(Opal) {
  ...
  return (function($base) {
    ...
    Opal.defn(self, '$benchmark', TMP_1 = function benchmark(caption, label_width, format) {
      var $a, $b, $c, TMP_2, self = this, $rest_idx, $rest_len = arguments.length - 3, $iter = TMP_1.$$p, $yield = $iter || nil, sync = nil, report = nil, results = nil;

      var labels = new Array($rest_len > 0 ? $rest_len : 0);
      if ($rest_len > 0) {
        for ($rest_idx = 0; $rest_idx < $rest_len; $rest_idx++) {
          labels[$rest_idx] = arguments[$rest_idx + 3];
        }
      }
      if (caption == null) {
        caption = ""
...
if (t == null) t = nil;
    ...
    Opal.defn(self, '$bm', TMP_3 = function bm(label_width) {
      var $a, $b, self = this, $rest_idx, $rest_len = arguments.length - 1, $iter = TMP_3.$$p, blk = $iter || nil;

      var labels = new Array($rest_len > 0 ? $rest_len : 0);
      if ($rest_len > 0) {
        for ($rest_idx = 0; $rest_idx < $rest_len; $rest_idx++) {
          labels[$rest_idx] = arguments[$rest_idx + 1];
        }
      }
      if (label_width == null) {
        label_width = 0
...
if (res == null) res = nil;
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$initialize', function initialize(width) {
        var self = this;
      ...
      Opal.defn(self, '$item', TMP_10 = function item(label) {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$initialize', function initialize(width, format) {
        var $a, self = this;
      ...
      Opal.defn(self, '$item', TMP_11 = function item(label) {
        var $a, $b, self = this, $rest_idx, $rest_len = arguments.length - 1, $iter = TMP_11.$$p, blk = $iter || nil, res = nil;

        var format = new Array($rest_len > 0 ? $rest_len : 0);
        if ($rest_len > 0) {
          for ($rest_idx = 0; $rest_idx < $rest_len; $rest_idx++) {
            format[$rest_idx] = arguments[$rest_idx + 1];
          }
        }
        if (label == null) {
          label = ""
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$initialize', function initialize(utime, stime, cutime, cstime, real, label) {
        var $a, self = this;
      ...
      Opal.defn(self, '$add', TMP_12 = function add() {
      ...
      Opal.defn(self, '$format', function format(format) {
        var $a, $b, TMP_14, $c, $d, TMP_15, $e, $f, TMP_16, $g, $h, TMP_17, $i, $j, TMP_18, $k, $l, TMP_19, $m, $n, TMP_20, $o, self = this, $rest_idx, $rest_len = arguments.length - 1, str = nil;
      ...
      return (Opal.defn(self, '$memberwise', function memberwise(op, x) {
