...
Opal.modules["console"] = function(Opal) {
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$trace', function trace() {
      var self = this;

      return self["native"].trace();
    });

    Opal.defn(self, '$log', function log() {
    ...
    Opal.defn(self, '$info', function info() {
      var self = this, $rest_idx, $rest_len = arguments.length - 0;
    ...
    Opal.defn(self, '$error', function error() {
      var self = this, $rest_idx, $rest_len = arguments.length - 0;
    ...
    Opal.defn(self, '$time', TMP_1 = function time(label) {
    ...
    Opal.defn(self, '$group', TMP_2 = function group() {
      var $a, $b, self = this, $rest_idx, $rest_len = arguments.length - 0, $iter = TMP_2.$$p, block = $iter || nil;
    ...
    return (Opal.defn(self, '$group!', TMP_3 = function () {
      var $a, $b, self = this, $rest_idx, $rest_len = arguments.length - 0, $iter = TMP_3.$$p, block = $iter || nil;
