...
Opal.modules["observer"] = function(Opal) {
  ...
  return (function($base) {
    ...
    Opal.defn(self, '$add_observer', function add_observer(observer, func) {
      var $a, $b, self = this;
    ...
    Opal.defn(self, '$delete_observer', function delete_observer(observer) {
      var $a, $b, self = this;
      if (self.observer_peers == null) self.observer_peers = nil;
    ...
    Opal.defn(self, '$delete_observers', function delete_observers() {
      var $a, $b, self = this;
      if (self.observer_peers == null) self.observer_peers = nil;
    ...
    Opal.defn(self, '$count_observers', function count_observers() {
      var $a, $b, self = this;
      if (self.observer_peers == null) self.observer_peers = nil;
    ...
    Opal.defn(self, '$changed', function changed(state) {
      var self = this;
    ...
    Opal.defn(self, '$notify_observers', function notify_observers() {
      var $a, $b, $c, TMP_1, self = this, $rest_idx, $rest_len = arguments.length - 0;
      if (self.observer_state == null) self.observer_state = nil;
      if (self.observer_peers == null) self.observer_peers = nil;

      var arg = new Array($rest_len > 0 ? $rest_len : 0);
      if ($rest_len > 0) {
        for ($rest_idx = 0; $rest_idx < $rest_len; $rest_idx++) {
          arg[$rest_idx] = arguments[$rest_idx + 0];
        }
      }
      if ((($a = ($b = (($c = self['observer_state'], $c != null && $c !== nil) ? 'instance-variable' : nil), $b !== false && $b !== nil ?self.observer_state : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        if ((($a = (($b = self['observer_peers'], $b != null && $b !== nil) ? 'instance-variable' : nil)) !== nil && (!$a.$$is_boolean || $a == true))) {
