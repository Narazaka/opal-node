...
Opal.modules["thread"] = function(Opal) {
  ...
  (function($base, $super) {
    ...
    Opal.defs(self, '$current', function current() {
      var $a, self = this;
    ...
    Opal.defs(self, '$list', function list() {
      var self = this;
    ...
    Opal.defn(self, '$thread_variable_get', function thread_variable_get(key) {
      var self = this;

      return self.thread_locals['$[]'](self.$coerce_key_name(key));
    });

    Opal.defn(self, '$thread_variable_set', function thread_variable_set(key, value) {
      var self = this;
    ...
    Opal.defn(self, '$thread_variables', function thread_variables() {
      var self = this;
    ...
    Opal.defn(self, '$coerce_key_name', function coerce_key_name(key) {
      var self = this;
    ...
    return (function($base, $super) {
      ...
      Opal.defn(self, '$pop', function pop(non_block) {
        var $a, self = this;
      ...
      Opal.defn(self, '$push', function push(value) {
        var self = this;
      ...
      return (Opal.defn(self, '$each', TMP_1 = function each() {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$lock', function lock() {
      var $a, self = this;
    ...
    Opal.defn(self, '$try_lock', function try_lock() {
      var $a, self = this;
    ...
    Opal.defn(self, '$unlock', function unlock() {
      var $a, self = this;
    ...
    return (Opal.defn(self, '$synchronize', TMP_2 = function synchronize() {
