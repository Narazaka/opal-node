...
Opal.modules["forwardable"] = function(Opal) {
  ...
  (function($base) {
    ...
    Opal.defn(self, '$instance_delegate', function instance_delegate(hash) {
...
if (method == null) method = nil;
    ...
    Opal.defn(self, '$def_instance_delegators', function def_instance_delegators(accessor) {
      var $a, $b, TMP_3, self = this, $rest_idx, $rest_len = arguments.length - 1;

      var methods = new Array($rest_len > 0 ? $rest_len : 0);
      if ($rest_len > 0) {
        for ($rest_idx = 0; $rest_idx < $rest_len; $rest_idx++) {
          methods[$rest_idx] = arguments[$rest_idx + 1];
        }
      }
...
if (method == null) method = nil;
    ...
    Opal.defn(self, '$def_instance_delegator', function def_instance_delegator(accessor, method, ali) {
...
args = $slice.call(arguments, 0);
  ...
  return (function($base) {
    ...
    Opal.defn(self, '$single_delegate', function single_delegate(hash) {
...
if (method == null) method = nil;
    ...
    Opal.defn(self, '$def_single_delegators', function def_single_delegators(accessor) {
      var $a, $b, TMP_8, self = this, $rest_idx, $rest_len = arguments.length - 1;
...
if (method == null) method = nil;
    ...
    Opal.defn(self, '$def_single_delegator', function def_single_delegator(accessor, method, ali) {
