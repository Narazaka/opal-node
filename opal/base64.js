...
Opal.modules["base64"] = function(Opal) {
  ...
  return (function($base) {
    ...
    Opal.defs(self, '$decode64', function decode64(string) {
      var self = this;

      return decode(string.replace(/\r?\n/g, ''));
    });

    Opal.defs(self, '$encode64', function encode64(string) {
      var self = this;

      return encode(string).replace(/(.{60})/g, "$1\n");
    });

    Opal.defs(self, '$strict_decode64', function strict_decode64(string) {
      var self = this;

      return decode(string);
    });

    Opal.defs(self, '$strict_encode64', function strict_encode64(string) {
      var self = this;

      return encode(string);
    });

    Opal.defs(self, '$urlsafe_decode64', function urlsafe_decode64(string) {
      var self = this;

      return decode(string.replace(/\-/g, '+').replace(/_/g, '/'));
    });

    Opal.defs(self, '$urlsafe_encode64', function urlsafe_encode64(string) {
      var self = this;
