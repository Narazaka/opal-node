...
Opal.modules["stringio"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$initialize', function initialize(string, mode) {
      var $a, $b, self = this;
    ...
    Opal.defn(self, '$seek', function seek(pos, whence) {
    ...
    Opal.defn(self, '$tell', function tell() {
      var self = this;
    ...
    Opal.defn(self, '$rewind', function rewind() {
      var self = this;

      return self.$seek(0);
    });

    Opal.defn(self, '$each_byte', TMP_2 = function each_byte() {
    ...
    Opal.defn(self, '$each_char', TMP_3 = function each_char() {
    ...
    Opal.defn(self, '$read', function read(length, outbuf) {
    ...
    Opal.defn(self, '$close', function close() {
      var self = this;

      return self.closed = "both";
    });

    Opal.defn(self, '$close_read', function close_read() {
      var self = this;
    ...
    Opal.defn(self, '$close_write', function close_write() {
      var self = this;
    ...
    Opal.defn(self, '$check_writable', function check_writable() {
      var $a, self = this;
    ...
    return (Opal.defn(self, '$check_readable', function check_readable() {
      var $a, self = this;
