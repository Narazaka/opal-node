...
Opal.modules["delegate"] = function(Opal) {
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$initialize', function initialize(obj) {
      var self = this;

      return self.$__setobj__(obj);
    });

    return (Opal.defn(self, '$method_missing', TMP_1 = function method_missing(m) {
      var $a, $b, self = this, $rest_idx, $rest_len = arguments.length - 1, $iter = TMP_1.$$p, block = $iter || nil, target = nil;
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$__getobj__', function __getobj__() {
      var self = this;

      return self.delegate_sd_obj;
    });

    return (Opal.defn(self, '$__setobj__', function __setobj__(obj) {
      var self = this;

      return self.delegate_sd_obj = obj;
    }), nil) && '__setobj__';
  })($scope.base, $scope.get('Delegator'));
  return (Opal.defn(Opal.Object, '$DelegateClass', function DelegateClass(superklass) {
    var self = this;
