...
Opal.modules["ostruct"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    def.table = nil;
    Opal.defn(self, '$initialize', function initialize(hash) {
...
if (key == null) key = nil;if (value == null) value = nil;
    ...
    Opal.defn(self, '$method_missing', function method_missing(name) {
      var $a, self = this, $rest_idx, $rest_len = arguments.length - 1;
    ...
    Opal.defn(self, '$each_pair', TMP_2 = function each_pair() {
      ...
      return ($a = ($b = self.table).$each_pair, $a.$$p = (TMP_3 = function(pair){var self = TMP_3.$$s || this;
if (pair == null) pair = nil;
      return Opal.yield1($yield, pair);}, TMP_3.$$s = self, TMP_3), $a).call($b);
    });
    ...
    Opal.defn(self, '$delete_field', function delete_field(name) {
    ...
    Opal.defn(self, '$new_ostruct_member', function new_ostruct_member(name) {
