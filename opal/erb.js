...
Opal.modules["template"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defs(self, '$paths', function paths() {
      var self = this;
      if (self._cache == null) self._cache = nil;
    ...
    Opal.defn(self, '$render', function render(ctx) {
      var $a, $b, self = this;
    ...
    return (function($base, $super) {
      ...
      Opal.defn(self, '$append', function append(str) {
        var self = this;
      ...
      return (Opal.defn(self, '$join', function join() {
        var self = this;
...
Opal.modules["erb"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    return (function($base) {
      ...
      Opal.defn(self, '$html_escape', function html_escape(str) {
        var self = this;
