...
Opal.modules["singleton"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      Opal.defn(self, '$inherited', TMP_2 = function inherited(sub_klass) {
    ...
    (function(self) {
      ...
      Opal.defn(self, '$__init__', function __init__(klass) {
        ...
        Opal.defs(klass, '$instance', function instance() {
          var $a, self = this;
      ...
      return (Opal.defn(self, '$included', TMP_4 = function included(klass) {
