...
Opal.modules["nodejs/kernel"] = function(Opal) {
  ...
  (function($base) {
    ...
    Opal.defn(self, '$node_require', function node_require(path) {
      var self = this;
...
Opal.modules["nodejs/file"] = function(Opal) {
  ...
  Opal.add_stubs(['$include', '$node_require', '$size', '$join', '$raise', '$message', '$error', '$call', '$exist?', '$new', '$close', '$match', '$warn', '$gsub', '$attr_reader']);
  return (function($base, $super) {
    ...
    Opal.defs(self, '$read', function read(path) {
      var self = this;

      return __fs__.readFileSync(path).toString();
    });

    Opal.defs(self, '$write', function write(path, data) {
      var self = this;
    ...
    Opal.defs(self, '$realpath', TMP_1 = function realpath(pathname, dir_string, cache) {
    ...
    Opal.defs(self, '$basename', function basename(path, ext) {
      var self = this;

      return __path__.basename(path, ext);
    });

    Opal.defs(self, '$dirname', function dirname(path) {
      var self = this;

      return __path__.dirname(path);
    });

    Opal.defs(self, '$join', function join() {
    ...
    Opal.defs(self, '$size', function size(path) {
      var $a, self = this;
    ...
    Opal.defs(self, '$open', TMP_2 = function open(path, flags) {
      var self = this, $iter = TMP_2.$$p, $yield = $iter || nil, file = nil;
    ...
    Opal.defn(self, '$initialize', function initialize(path, flags) {
    ...
    return (Opal.defn(self, '$close', function close() {
      var self = this;
